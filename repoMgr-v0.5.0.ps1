...
$CFG-INFO = " - Configuration: -- Root: $root, `n -- SafeDest: $safedest, Timestamp: $timestamp, Lookback: $lookback, DR Branch: $drBranch"
Write-Host $CFG-INFO -ForegroundColor Magenta
log "CONFIG" $root $CFG-INFO
...
function Analyze-RepoRisk {
    ...
    $results | Format-Table Commit, File, GoodTimestamp, DetachedTimestamp, IsStale, IsDestructive -AutoSize
